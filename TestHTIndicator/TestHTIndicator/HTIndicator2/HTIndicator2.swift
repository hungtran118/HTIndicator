...
class HTIndicator2 {
    ...
    static let shared = HTIndicator2()
    ...
    private let indicatorColor: UIColor = UIColor(red: 0.4, green: 0.2, blue: 0.8, alpha: 1)
    ...
    private func setupIndicator() {
        let indicator = HTIndicatorView2(frame: indicatorView.bounds)
