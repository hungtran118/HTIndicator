...
class HTIndicator6 {
    ...
    static let shared = HTIndicator6()
    private let containerView = UIView()
    private var keyWindow = UIWindow()
    private var indicator: HTIndicatorView6 = HTIndicatorView6()
    
    //MARK: - Custom
    private let containerViewColor: UIColor = UIColor(white: 0, alpha: 0.3)
    private let indicatorSize: CGFloat = 60
    private let indicatorColor: UIColor = UIColor(red: 0.4, green: 0.8, blue: 0.2, alpha: 1)
    ...
    private func setupIndicator() {
        indicator = HTIndicatorView6(frame: indicatorView.bounds)
